 ...
 * @throws URISyntaxException 
   ...
   public void initAnnie() throws GateException, IOException, URISyntaxException {
     ...
     Out.prln(Gate.getPluginsHome());
     Plugin anniePlugin = new Plugin.Maven( "uk.ac.gate.plugins", "annie", gate.Main.version);
     annieController =
       (CorpusController) PersistenceManager.loadObjectFromUrl(new ResourceReference(anniePlugin, "resources/" + ANNIEConstants.DEFAULT_FILE).toURL());
